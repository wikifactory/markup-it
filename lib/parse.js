...
ParsingSession.prototype.pushBlock = function pushBlock(rule, block) {
    ...
    block.blockEntity = this.indexEntity(block.blockEntity);
    block.entityRanges = block.entityRanges.map(this.indexEntity.bind(this));
...
// Index an entity and returns the modified entity
ParsingSession.prototype.indexEntity = function indexEntity(entity) {
    entity.key = 'entity' + this.entityId;
    this.entityMap[entity.key] = entity.entity;
